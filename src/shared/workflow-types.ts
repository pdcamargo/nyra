...
export type WorkflowDefinition = {
  ...
  // Marketplace tracking — set when a workflow was installed from nyra-flows-marketplace
  marketplaceId?: string
  marketplaceVersion?: string
}

// --- Marketplace (community-shared workflows from nyra-flows-marketplace repo) ---
