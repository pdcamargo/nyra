 ...
 * header opens the Changes tab; a row opens it focused on that file.
 *
        ...
        {shown.map((f) => {
          ...
          return (
            <button
              ...
              title={f.path}
              className="flex w-full items-center gap-2 border-b border-border/55 px-2.5 py-1.5 text-left transition-colors last:border-b-0 hover:bg-accent/50"
            >
