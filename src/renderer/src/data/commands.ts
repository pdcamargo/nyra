export const BUILT_IN_COMMANDS = [
  ...
  { name: '/mcp', description: 'Explore MCP servers and their tools' },
  { name: '/plugin', description: 'Browse and manage Claude Code plugins' },
  { name: '/marketplace', description: 'Browse Claude Code plugins' },
