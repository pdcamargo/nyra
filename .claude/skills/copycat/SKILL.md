...
Find what's new in Claude Code that nyra doesn't have yet, assess feasibility, and update the roadmap.
...
3. **Compare and identify gaps**
   ...
   - For each, mark whether nyra: ✅ already has it, 🟡 has it partially, or ❌ doesn't have it
